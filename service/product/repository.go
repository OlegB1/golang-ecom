...
func (s *Repository) GetProducts(p types.Pagination) ([]types.Product, error) {
...
func (s *Repository) CreateProduct(p types.CreateProductPayload) (types.Product, error) {
...
func (s *Repository) GetProductsByIds(tx *sql.Tx, productIDs []int) ([]types.Product, error) {
...
func (s *Repository) UpdateProducts(tx *sql.Tx, products []*types.Product) {
